...
[![Deploy to Netlify Button](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/netlify-templates/my-demo-site)
...
- Or via the command line `git clone https://github.com/netlify-templates/my-demo-site`
...
> 🚨 If you decide to change the project name be sure to change it everywhere in the project including the [Netlify configuration file, `netlify.toml`](./netlify.toml), as there are many places in Angular projects where the project name is used. A quick fix is to find/replace all instances of `my-demo-site` with your project name.
...
- Use the Netlify CLI's create from template command `netlify sites:create-template my-demo-site` which will create a repo, Netlify project, and deploy it
...
If you decide that our styling is not for you, all you'll need to do is remove the [demo-styling.css](https://github.com/netlify-templates/my-demo-site/blob/tn/designUpdates/src/demo-styling.css) file. 
